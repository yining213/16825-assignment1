...
def render_cow_360degrees(cow_path="data/cow.obj", image_size=256, color=[0.7, 0.7, 1], device=None):
...
if __name__ == '__main__':
    ...
    my_images = render_cow_360degrees(device=device)  # List of images [(H, W, 3)]
